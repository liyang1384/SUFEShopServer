...
class Commodity(models.Model):
    ...
    # commodityapplication = models.OneToOneField("CommodityApplication",on_delete=models.CASCADE)
...
class CommodityApplication(models.Model):
    ...
    auditor = models.ForeignKey("UserService.User",related_name='auditor',to_field='user_id',on_delete=models.CASCADE,blank=True,null=True,default=0)
